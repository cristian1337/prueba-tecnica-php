...
<body>
    ...
    <div class="collapse navbar-collapse">
        ...
        <a href="sale.php" class="btn btn-primary" ><span class="badge bg-secondary" id="cartNum"><?php echo $numCart; ?></span> Carrito</a>
    </div>
    </nav>
                    ...
                    <div class="col-4 mb-3">
                        <div class="card" style="width: 20rem;">
                            <div class="card-body">
                                ...
                                <a href="#" onclick="addProductCart(<?php echo $product->idProduct; ?>)" class="btn btn-primary card-link">Agregar al carito</a>
                            </div>
                        </div>
                    </div>
                    <?php
...
<script>
    function addProductCart(idProduct) {
        ...
        .then(data => {
            if(data.ok) {
                let carritoNum = document.getElementById('cartNum')
                carritoNum.innerHTML = data.numero
            }
        })
    }
</script>
